...
func TestSign(t *testing.T) {
	//req := `{"timestamp": "1727678539", "data": {"ad_campaign_id": "7419936128838565929", "media_channel_type": 5}, "app_id": "1818298863859134465"}`
	r := RequestBody{
	...
	final := sign(s, "51bfab7ca36ffe3a514b67332d41ecadfd")
	fmt.Println(final)
}
