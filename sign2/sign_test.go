...
// @return string
func sign(body []byte, appSecret string) string {
	...
	x1 := s1 + appSecret
	//x1 = "app_id1818298863859134465data{\"ad_campaign_id\": \"7419936128838565929\", \"media_channel_type\": 5}timestamp172768735551bfab7ca36ffe3a514b67332d41ecadfd"
	fmt.Printf("[CheckRequestSignValid] x1: %s \n", x1)
...
func TestSign(t *testing.T) {
	req := `{"timestamp": "1727687355", "data": {"ad_campaign_id": "7419936128838565929", "media_channel_type": 5}, "app_id": "1818298863859134465"}`
	//r := RequestBody{
	//	Timestamp: "1727687355",
	//	AppID:     "1818298863859134465",
	//	Data:      map[string]interface{}{"ad_campaign_id": "7419936128838565929", "media_channel_type": 5},
	//}
	...
	final := sign([]byte(req), "51bfab7ca36ffe3a514b67332d41ecadfd")
	fmt.Println(final)
}
